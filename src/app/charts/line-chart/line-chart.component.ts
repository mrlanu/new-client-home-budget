...
export class LineChartComponent implements OnInit, OnDestroy {
  ...
  constructor(private summariesService: SummariesService, private utilitiService: UtilityService) { }

  ngOnInit() {
    this.componentSubs.push(this.utilitiService.categoriesChanged
    ...
    this.utilitiService.getAllCategories();
  }
